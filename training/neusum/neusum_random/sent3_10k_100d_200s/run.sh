...
SAVEPATH=/idiap/temp/jbello/training/neusum/neusum_random/sent3_10k_100d_200s/
...
/idiap/temp/jbello/anaconda3/envs/nse/bin/python3 train.py -save_path ${SAVEPATH} \
                ...
                -src_vocab ${DATAHOME}/neusum_random/sent3_10k_100d_200s/vocab.txt.10k \
                -train_tgt ${DATAHOME}/train.tgt.txt \
                -tgt_vocab ${DATAHOME}/neusum_random/sent3_10k_100d_200s/vocab.txt.10k \
		...
		-pre_word_vecs_enc ${DATAHOME}/neusum_random/sent3_10k_100d_200s/random.xavier.100d.txt \
