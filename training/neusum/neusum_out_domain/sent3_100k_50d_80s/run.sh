...
SAVEPATH=/idiap/temp/jbello/training/neusum/neusum_out_domain/sent3_100k_50d_80s/
...
/idiap/temp/jbello/anaconda3/envs/nse/bin/python3 train.py -save_path ${SAVEPATH} \
                ...
                -src_vocab ${DATAHOME}/neusum_out_domain/sent3_100k_50d_80s/vocab.txt.100k \
                -train_tgt ${DATAHOME}/train.tgt.txt \
                -tgt_vocab ${DATAHOME}/neusum_out_domain/sent3_100k_50d_80s/vocab.txt.100k \
                ...
                -pre_word_vecs_enc ${DATAHOME}/neusum_out_domain/sent3_100k_50d_80s/glove.6B.50d.txt \
