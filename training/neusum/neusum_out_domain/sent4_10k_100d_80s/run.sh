...
SAVEPATH=/idiap/temp/jbello/training/neusum/neusum_out_domain/sent4_10k_100d_80s/
...
/idiap/temp/jbello/anaconda3/envs/nse/bin/python3 train.py -save_path ${SAVEPATH} \
                ...
                -src_vocab ${DATAHOME}/neusum_out_domain/sent4_10k_100d_80s/vocab.txt.10k \
                -train_tgt ${DATAHOME}/train.tgt.txt \
                -tgt_vocab ${DATAHOME}/neusum_out_domain/sent4_10k_100d_80s/vocab.txt.10k \
                ...
                -pre_word_vecs_enc ${DATAHOME}/neusum_out_domain/sent4_10k_100d_80s/glove.6B.100d.txt \
