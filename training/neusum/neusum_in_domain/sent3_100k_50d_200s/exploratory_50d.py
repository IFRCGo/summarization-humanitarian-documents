...
model_path = '/idiap/temp/jbello/training/neusum/neusum_in_domain/sent3_100k_50d_200s/gloveDEEP_50d.pt'

save_path = '/idiap/temp/jbello/data/training/neusum/neusum_in_domain/sent3_100k_50d_200s/'

model = GloveModel(272449,50)
...
save_texts(save_path,'glove_emb.50d',[f_emb],[''])
'Saved texts!'
...
plt.savefig('/idiap/temp/jbello/training/neusum/neusum_in_domain/sent3_100k_50d_200s/glove_emb50d.png')
