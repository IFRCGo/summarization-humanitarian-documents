...
model_path = '/idiap/temp/jbello/training/neusum/neusum_in_domain/sent3_100k_100d_80s/gloveDEEP.pt'

save_path = '/idiap/temp/jbello/data/training/neusum/neusum_in_domain/sent3_100k_100d_80s/'
...
dataset = GloveDataset(open("/idiap/temp/jbello/data/training/neusum/train.src.txt").read(), 10000000)
...
plt.savefig('/idiap/temp/jbello/training/neusum/neusum_in_domain/sent3_100k_100d_80s/glove_emb100d.png')
