...
SAVEPATH=/idiap/temp/jbello/training/neusum/neusum_in_domain/sent3_10k_50d_200s/
...
/idiap/temp/jbello/anaconda3/envs/nse/bin/python3 /idiap/temp/jbello/models/neusum/NeuSum/neusum_pt/train.py -save_path ${SAVEPATH} \
                ...
                -src_vocab /idiap/temp/jbello/data/training/neusum/neusum_in_domain/sent3_10k_50d_200s/vocab.txt.10k \
                -train_tgt /idiap/temp/jbello/data/training/neusum/train.tgt.txt \
                -tgt_vocab /idiap/temp/jbello/data/training/neusum/neusum_in_domain/sent3_10k_50d_200s/vocab.txt.10k \
                ...
                -pre_word_vecs_enc /idiap/temp/jbello/data/training/neusum/neusum_in_domain/sent3_10k_50d_200s/glove.10k.50d.txt \
