...
'''
save_path_train = '/idiap/temp/jbello/data/training/neusum/'
'''
save_path_val = '/idiap/temp/jbello/data/validation/neusum/'
...
#clean_data_to_format(data_directory, partition_file, save_path_train, 'training', 'document.','train.src')
#clean_data_to_format(data_directory, partition_file, save_path_train, 'training', 'summary.','train.tgt')
#clean_data_to_format(data_directory, partition_file, save_path_val, 'validation','document.','val.src')
clean_data_to_format(data_directory, partition_file, save_path_val, 'validation','summary.','val.tgt')
