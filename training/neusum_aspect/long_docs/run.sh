...
EXEHOME=/idiap/temp/jbello/models/neusum_aspect/NeuSum/neusum_pt/

ls -l ${DATAHOME}

ls -l ${EXEHOME}

SAVEPATH=/idiap/temp/jbello/training/neusum_aspect/long_docs/

mkdir -p ${SAVEPATH}

cd ${EXEHOME}

/idiap/temp/jbello/anaconda3/envs/nse/bin/python3 /idiap/temp/jbello/models/neusum_aspect/NeuSum/neusum_pt/train.py -save_path ${SAVEPATH} \
                -online_process_data \
                -max_doc_len 200 \
                ...
                -src_vocab /idiap/temp/jbello/data/training/neusum_aspect/vocab.txt.100k \
                -train_tgt /idiap/temp/jbello/data/training/neusum/train.tgt.txt \
                -tgt_vocab /idiap/temp/jbello/data/training/neusum_aspect/vocab.txt.100k \
                ...
                -pre_word_vecs_enc /idiap/temp/jbello/data/training/neusum_aspect/glove.100k.50d.txt \
                ...
                -max_decode_step 6 -force_max_len
