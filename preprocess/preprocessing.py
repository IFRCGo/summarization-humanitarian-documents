...
MULTILINGUAL_FILTERS = [
    lambda x: x.lower(), strip_tags, strip_punctuation,
    strip_multiple_whitespaces, strip_numeric,
]

def preprocess_string(s, filters=MULTILINGUAL_FILTERS):
...
def preprocess_documents(docs, filters = MULTILINGUAL_FILTERS ):
